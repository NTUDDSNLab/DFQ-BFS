...
// shared-q/stripe-sa/our-sep/upper-bound/
...
#define TILE_LOG_E     14
#define TILE_SIZ_E  16384
#define TILE_RNG_E  16384
...
__device__ int ftr_size_EQ, ftr_size_FQ;
__global__ void CUDA_BFS_KERNEL_CG_NEW(Node *node, int *edge, short *cost, bool *done, int *NUM_NODES)
{
    ...
    __shared__ int ftr_size_AQ, ftr_size_BQ, ftr_size_CQ;
